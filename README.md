...
The program can be easily run from the executable [CompilatoreACDC.jar](https://github.com/). Just feed it a text file containing a (valid) ac source file and let the program do its magic.
